...
\begin{enumerate}
	...
	\item (Section 2.5, Related Exercise 51)
        $$f(x) = \frac{x^2 - 3}{x+6} = \frac{}{}$$
        $$\lim_{x \to \infty}{\frac{x^2 - 3}{x+6}} = \lim_{x \to \infty}{\frac{x^2 - 3}{x+6}}$$
	...
	\item (Section 2.5, Related Exercise 46)
        ...
        \begin{eqnarray}
            f(x) &=& \frac{\sqrt{x^2 + 1}}{2x+1} \\
                 &=& \frac{\frac{1}{2x+1}\sqrt{x^2+1}}{\frac{2x+1}{2x+1}} \\
                 &=& \frac{1}{2x+1}\sqrt{x^2+1} \\
                 &=& \frac{1}{\sqrt{(2x+1)^2}}\sqrt{x^2+1} \\
                 &=& \sqrt{\frac{x^2+1}{(2x+1)^2}} \\
                 &=& \sqrt{\frac{x^2+1}{4x^2+4x+1}} \\
        \end{eqnarray}
