...
\begin{enumerate}
    ...
    \item (Section 3.11 Exercise 37)
        \begin{eqnarray}
            \frac{dh}{dt} &=& -1 \\
            \frac{dV}{dt} &=& \frac{1}{3}\pi \frac{d}{dt}\left(\left(\frac{h}{2}\right)^2h\right) \\
                          &=& \frac{1}{3}\pi \frac{d}{dt}\left(\left(\frac{6}{2}\right)^23\right) \\
                          &=& \frac{27}{3}\pi \\
                          &=& 9\pi
        \end{eqnarray}
    \item (Section 3.11 Exercise 46)
    \begin{eqnarray}
        \frac{dy}{dt} &=& 20 \\
        \tan{\theta} &=& \frac{y}{300} \\
        \theta &=& \tan^{-1}{\frac{y}{300}} \\
        \frac{d\theta}{dt} &=& \frac{1}{1 + \left(\frac{y}{300}\right)^2} \cdot \frac{d}{dt}\left(\frac{y}{300}\right) \cdot \frac{dy}{dt} \\
                           &=& \frac{1}{1 + \left(\frac{400}{300}\right)^2} \cdot \frac{1}{300} \cdot 20 \\
                           &=& \frac{1}{1 + \left(\frac{400}{300}\right)^2} \cdot \frac{1}{300} \cdot 20 \\
                           &=& 0.024
    \end{eqnarray}
\end{enumerate}
